      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <button
            ...
            className="block w-full px-4 py-2 text-sm text-left text-gray-100 bg-blue-800 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 hover:text-black rounded-lg"
          >
            {" "}
            Sign out{" "}
          </button>
